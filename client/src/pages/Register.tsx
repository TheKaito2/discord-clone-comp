...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-rail p-4">
      ...
      >
        <h1 className="text-2xl font-bold text-text-hi text-center">Create an account</h1>

        <label className="cap block mt-6 mb-2">Username</label>
        <input
          value={username}
        ...
        <p className="text-text-sub text-sm mt-4">
          Already have one?{' '}
          <Link to="/login" className="text-mention hover:underline">
            Log in
          </Link>
        </p>
      </form>
